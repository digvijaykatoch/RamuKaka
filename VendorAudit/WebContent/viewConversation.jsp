<%@page import="com.schein.bean.EmailTable"%>
...
//if there is any message/error/info that should be displayed ,it will be saved in the request object and send back to this page 
 ...
 if(request.getAttribute("conversation")!=null){
 conversation = (EmailTable) request.getAttribute("conversation");
 }
    ...
    <div class="container">    
      ...
      <img alt="img" src="assets/img/covers/logo-global.gif"  class = "img-responsive" style="padding-left: 8%">
          ...
          <h1 class="display-4 text-center mb-3">
            ...
            Email for control no <%=conversation.getControlNo() %>
          </h1>
          
          <!-- Subject -->
          <p class="text-muted text-center mb-5">
            <B>Subject: </B><%=conversation.getSubject()%>
          </p>
